// Floating Tweaks panel + the form controls App uses (Section / Radio / Color
// / Text). Owns the design-tool host protocol: listens for
// __activate/__deactivate_edit_mode, posts __edit_mode_available/_dismissed.

import { useCallback, useEffect, useRef, useState, type ReactNode } from 'react';

const TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:min(280px,calc(100vw - 32px));
